...
public class AddPrediction {
  ...
  public static void main(String[] args) {
    ...
    PCollection<Record> records = io //
        .readInstances(p, options) //
        .apply(Window.<Record> into(FixedWindows.of(Duration.standardSeconds(20))).withAllowedLateness(Duration.standardSeconds(10)).discardingFiredPanes());

    io.writePredictions(records, options);
